...
`/api/v1/transaction?access_code={}`
...
`curl  "http://server:port/api/v1/getnewaddress?access_code={}"`
...
`/api/v1/sendtoaddress?access_code={}`
...
`/api/v1/asset/balances/:addr?access_code={}`
...
`/api/v1/asset/balance/:addr/:asset?access_code={}`
...
```
 {
     "Action": "getbalancebyasset?access_code={}",
     "Desc": "SUCCESS",
     "Error": 0,
     "Result": "100000",
     "Version": "1.0.0"
...
`/api/v1/block/height?access_code={}`
